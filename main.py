...
app = FastAPI(title='Backstract Generated APIs - coll-976401375f1e44959fc4400205dd10a5', debug=False,
              docs_url='/busy-tejas-79b04ed6200811f0a0f60242ac12000431/docs',
              openapi_url='/busy-tejas-79b04ed6200811f0a0f60242ac12000431/openapi.json')
...
app.include_router(
    router,
    prefix='/busy-tejas-79b04ed6200811f0a0f60242ac12000431/api',
    tags=['APIs v1']
)
